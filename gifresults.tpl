						...
						<br/>
							%for gif,gif2 in zip(lista_gifs,titulos_gifs):
								...
								<ul>
									...
									<li><h1><strong><a href="https://twitter.com/share?url=google.com&text=Me gusta el gif https://media2.giphy.com/media/{{gif2}}/giphy.gif de SwissKnife GIF">Twittear</strong></a></h1></li>
								</ul>
							%end
