						...
						<br/>
							%for gif,gif2 in zip(lista_gifs,titulos_gifs):
								...
								<ul>
									...
									<li><h1><strong><a href="https://twitter.com/share?url=google.com&text=Me gusta el gif {{q}} de SwissKnife GIF"&img= <img width="600" height="400" src="{{gif}}"/>>Twittear</strong></a></h1></li>
								</ul>
							%end
