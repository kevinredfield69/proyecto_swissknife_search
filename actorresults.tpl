						...
						<br/>
							%for actor,descripcion,fecha,calificacion in zip(lista_actores,actores_descripciones,actores_fechas,actores_calificaciones):
								<ul>
									...
									<li><h3><strong><a href="https://twitter.com/share?url=google.com&text=Me gusta la película {{actor}} del actor {{query}} de SwissKnife Actor">Twittear</a></strong></h3></li>
